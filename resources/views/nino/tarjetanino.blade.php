...
<div class="position-absolute top-50 start-50 translate-middle">
    <div class="container-fluid">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Gallo.png') }}" class="card-img-top" alt="Gallo pinto">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Familia.png') }}" class="card-img-top" alt="Familia">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Amigos.png') }}" class="card-img-top" alt="Amigos">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Juguetes.png') }}" class="card-img-top" alt="Juguetes">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Colegio.png') }}" class="card-img-top" alt="Colegio">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                <img src="{{ asset('/Image/Naturaleza.png') }}" class="card-img-top" alt="Naturaleza">
                    <div class="card-body">
